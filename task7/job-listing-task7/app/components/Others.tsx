    ...
    <div className="w-[80%] mx-auto flex flex-col gap-5">
      ...
      <div className="flex items-start gap-2 mb-2">
        ...
        <div className="px-3 flex-col">
          ...
          <p className="font-[600]">{formatDateToCustomString(job.datePosted)}</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 items-start mb-2">
        ...
        <div className="px-3 flex-col">
          ...
          <div className="font-[600]">{formatDateToCustomString(job.deadline)}</div>
        </div>
      </div>
      ...
      <div className="flex gap-2 items-start mb-2">
        ...
        <div className="px-3 flex-col">
          ...
          <p className="font-[600]">{formatDateToCustomString(job.startDate)}</p>
        </div>
      </div>
